...
public class Controller : MonoBehaviour
{
    ...
    async Task Start()
    {
        var gameDataBinFolder = UbiCanvasSettings.CurrentGameDataDir;
        ...
        loader.pathFolder = System.IO.Path.GetDirectoryName(UbiCanvasSettings.SelectedLevelFile);
        loader.pathFile = System.IO.Path.GetFileName(UbiCanvasSettings.SelectedLevelFile);
