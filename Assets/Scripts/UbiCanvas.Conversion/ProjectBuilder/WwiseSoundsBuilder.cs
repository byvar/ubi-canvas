...
namespace UbiCanvas.Conversion {
	public class WwiseSoundsBuilder : ProjectBuilder {

		public WwiseSoundsBuilder(string path) : base(path) { }

		public override string ID => "wwise";
		...
		protected void BuildFile(string wavFilePath, string uncookedPath) {
			...
			if (!FileIsAlreadyBuilt(cookedPath)) {
				...
				using (var readMS = new System.IO.FileStream(wavFilePath, System.IO.FileMode.Open)) {
