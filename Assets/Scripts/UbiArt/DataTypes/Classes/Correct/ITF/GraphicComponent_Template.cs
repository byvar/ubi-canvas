	...
	public partial class GraphicComponent_Template : ActorComponent_Template {
		...
		protected override void SerializeImpl(CSerializerObject s) {
			...
			if (s.Settings.Game == Game.RJR || s.Settings.Game == Game.RFR || s.Settings.Game == Game.RO) {
				if (this is FxBankComponent_Template || this is ParticleGeneratorComponent_Template || this is ProceduralSoftPlatformComponent_Template || this is SwarmComponent_Template) return;
