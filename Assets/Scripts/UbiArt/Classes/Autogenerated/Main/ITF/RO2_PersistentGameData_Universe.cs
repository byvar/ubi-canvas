...
namespace UbiArt.ITF {
	...
	public partial class RO2_PersistentGameData_Universe : PersistentGameData_Universe {
		...
		public CArray<int> unlockedPets;
		public CList<RO2_PersistentGameData_Universe.petRewardData> petsDailyReward;
		public CList<RO2_PersistentGameData_Universe.st_petCups> unlockedCupsForPets;
		...
		public CList<RO2_PersistentGameData_Universe.UnlockedDoor> newUnlockedDoor;
		public CList<RO2_PersistentGameData_Universe.RO2_LuckyTicketReward> luckyTicketRewardList;
		public CList<RO2_PersistentGameData_Universe.NodeDataStruct> nodeData;
		...
		public CList<uint> playedChallenge;
		...
		public CList<RO2_PersistentGameData_Universe.RLC_AdventureNodeData> adventureNodeDataList;
		...
		public CArray<Vec3d> lastChallengeTombs;
		...
		public CList<RO2_PersistentGameData_Universe.RLC_MissionData> missionDataList;
		public CList<RO2_PersistentGameData_Universe.RLC_CreatureData> creatureDataList;
		...
		public CList<RO2_PersistentGameData_Universe.RLC_ElixirUtilisation> incubatorElixirUtilisations;
		...
		public CList<RO2_PersistentGameData_Universe.RLC_CostumePlayTime> CostumePlayTime;
		...
		public CList<uint> alreadyBoughtStarterPacks;
		public CList<uint> alreadyBoughStoreBundles;
		public CList<RLC_ShopCostumeVersion> alreadySeenCostumeTrades;
		...
		public CList<RLC_GraphicalFamily> revealedRegions;
		public CList<RO2_PersistentGameData_Universe.RLC_NextRegionTravelMark> nextRegionTravelMarks;
		public CList<RO2_PersistentGameData_Universe.RLC_NextRegionEggSelectionData> nextRegionEggSelectionData;
		...
		public CList<RLC_MailboxElementLight> readMailboxElements;
		...
		public CList<Message> messages;
		public CArray<StringID> mrDarkUnlockCount;
		public CArray<StringID> newCostumes;
		public CArray<StringID> costumeUnlockSeen;
		public CArray<StringID> retroUnlocks;
		public CArray<StringID> playedDiamondCupSequence;
		public CArray<StringID> costumes;
		public CArray<StringID> playedInvasion;
		public CArray<StringID> worldUnlockMessagesSeen;
		public CArray<StringID> doorUnlockMessageSeen;
		public CArray<StringID> doorUnlockDRCMessageRequired;
		...
		protected override void SerializeImpl(CSerializerObject s) {
			...
			if (Settings.s.game == Settings.Game.RL) {
				...
				unlockedPets = s.SerializeObject<CArray<int>>(unlockedPets, name: "unlockedPets");
				petsDailyReward = s.SerializeObject<CList<RO2_PersistentGameData_Universe.petRewardData>>(petsDailyReward, name: "petsDailyReward");
				unlockedCupsForPets = s.SerializeObject<CList<RO2_PersistentGameData_Universe.st_petCups>>(unlockedCupsForPets, name: "unlockedCupsForPets");
				...
				messages = s.SerializeObject<CList<Message>>(messages, name: "messages");
				...
				mrDarkUnlockCount = s.SerializeObject<CArray<StringID>>(mrDarkUnlockCount, name: "mrDarkUnlockCount");
				catchEmAllIndex = s.Serialize<uint>(catchEmAllIndex, name: "catchEmAllIndex");
				newCostumes = s.SerializeObject<CArray<StringID>>(newCostumes, name: "newCostumes");
				costumeUnlockSeen = s.SerializeObject<CArray<StringID>>(costumeUnlockSeen, name: "costumeUnlockSeen");
				retroUnlocks = s.SerializeObject<CArray<StringID>>(retroUnlocks, name: "retroUnlocks");
				newUnlockedDoor = s.SerializeObject<CList<RO2_PersistentGameData_Universe.UnlockedDoor>>(newUnlockedDoor, name: "newUnlockedDoor");
				luckyTicketRewardList = s.SerializeObject<CList<RO2_PersistentGameData_Universe.RO2_LuckyTicketReward>>(luckyTicketRewardList, name: "luckyTicketRewardList");
				nodeData = s.SerializeObject<CList<RO2_PersistentGameData_Universe.NodeDataStruct>>(nodeData, name: "nodeData");
				...
				playedDiamondCupSequence = s.SerializeObject<CArray<StringID>>(playedDiamondCupSequence, name: "playedDiamondCupSequence");
				costumes = s.SerializeObject<CArray<StringID>>(costumes, name: "costumes");
				playedChallenge = s.SerializeObject<CList<uint>>(playedChallenge, name: "playedChallenge");
				playedInvasion = s.SerializeObject<CArray<StringID>>(playedInvasion, name: "playedInvasion");
				...
				worldUnlockMessagesSeen = s.SerializeObject<CArray<StringID>>(worldUnlockMessagesSeen, name: "worldUnlockMessagesSeen");
				...
				doorUnlockMessageSeen = s.SerializeObject<CArray<StringID>>(doorUnlockMessageSeen, name: "doorUnlockMessageSeen");
				doorUnlockDRCMessageRequired = s.SerializeObject<CArray<StringID>>(doorUnlockDRCMessageRequired, name: "doorUnlockDRCMessageRequired");
				...
				bubbleDreamerDataDummy = s.SerializeObject<RO2_PersistentGameData_BubbleDreamerData>(bubbleDreamerDataDummy, name: "bubbleDreamerDataDummy");
				dummmyNodeData = s.SerializeObject<RO2_PersistentGameData_Universe.NodeDataStruct>(dummmyNodeData, name: "dummmyNodeData");
				adventureNodeDataList = s.SerializeObject<CList<RO2_PersistentGameData_Universe.RLC_AdventureNodeData>>(adventureNodeDataList, name: "adventureNodeDataList");
				...
				lastChallengeTombs = s.SerializeObject<CArray<Vec3d>>(lastChallengeTombs, name: "lastChallengeTombs");
				lastChallengeTombs = s.SerializeObject<CArray<Vec3d>>(lastChallengeTombs, name: "lastChallengeTombs");
				...
				missionDataList = s.SerializeObject<CList<RO2_PersistentGameData_Universe.RLC_MissionData>>(missionDataList, name: "missionDataList");
				creatureDataList = s.SerializeObject<CList<RO2_PersistentGameData_Universe.RLC_CreatureData>>(creatureDataList, name: "creatureDataList");
				...
				incubatorElixirUtilisations = s.SerializeObject<CList<RO2_PersistentGameData_Universe.RLC_ElixirUtilisation>>(incubatorElixirUtilisations, name: "incubatorElixirUtilisations");
				...
				CostumePlayTime = s.SerializeObject<CList<RO2_PersistentGameData_Universe.RLC_CostumePlayTime>>(CostumePlayTime, name: "CostumePlayTime");
				...
				alreadyBoughtStarterPacks = s.SerializeObject<CList<uint>>(alreadyBoughtStarterPacks, name: "alreadyBoughtStarterPacks");
				alreadyBoughStoreBundles = s.SerializeObject<CList<uint>>(alreadyBoughStoreBundles, name: "alreadyBoughStoreBundles");
				alreadySeenCostumeTrades = s.SerializeObject<CList<RLC_ShopCostumeVersion>>(alreadySeenCostumeTrades, name: "alreadySeenCostumeTrades");
				...
				revealedRegions = s.SerializeObject<CList<RLC_GraphicalFamily>>(revealedRegions, name: "revealedRegions");
				nextRegionTravelMarks = s.SerializeObject<CList<RO2_PersistentGameData_Universe.RLC_NextRegionTravelMark>>(nextRegionTravelMarks, name: "nextRegionTravelMarks");
				nextRegionEggSelectionData = s.SerializeObject<CList<RO2_PersistentGameData_Universe.RLC_NextRegionEggSelectionData>>(nextRegionEggSelectionData, name: "nextRegionEggSelectionData");
				...
				readMailboxElements = s.SerializeObject<CList<RLC_MailboxElementLight>>(readMailboxElements, name: "readMailboxElements");
		...
		public partial class SeasonalEventData : CSerializable {
			...
			public CList<uint> familyId;
			protected override void SerializeImpl(CSerializerObject s) {
				base.SerializeImpl(s);
				unlocked = s.Serialize<bool>(unlocked, name: "unlocked");
				finished = s.Serialize<bool>(finished, name: "finished");
				familyId = s.SerializeObject<CList<uint>>(familyId, name: "familyId");
			}
		}
