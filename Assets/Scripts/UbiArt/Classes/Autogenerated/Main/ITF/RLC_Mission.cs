...
namespace UbiArt.ITF {
	...
	public partial class RLC_Mission : CSerializable {
		...
		public CArray<uint> requiredHitCount;
		...
		public CList<RLC_Mission_Guard> startGuards;
		public CList<RLC_Mission_Guard> updateGuards;
		public CList<RLC_Mission_Guard> completionGuards;
		public CList<RLC_Mission_Guard> resetGuards;
		...
		protected override void SerializeImpl(CSerializerObject s) {
			...
			requiredHitCount = s.SerializeObject<CArray<uint>>(requiredHitCount, name: "requiredHitCount");
			requiredHitCount = s.SerializeObject<CArray<uint>>(requiredHitCount, name: "requiredHitCount");
			...
			startGuards = s.SerializeObject<CList<RLC_Mission_Guard>>(startGuards, name: "startGuards");
			updateGuards = s.SerializeObject<CList<RLC_Mission_Guard>>(updateGuards, name: "updateGuards");
			completionGuards = s.SerializeObject<CList<RLC_Mission_Guard>>(completionGuards, name: "completionGuards");
			resetGuards = s.SerializeObject<CList<RLC_Mission_Guard>>(resetGuards, name: "resetGuards");
