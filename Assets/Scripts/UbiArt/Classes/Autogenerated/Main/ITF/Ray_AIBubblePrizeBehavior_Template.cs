...
namespace UbiArt.ITF {
	...
	public partial class Ray_AIBubblePrizeBehavior_Template : TemplateAIBehavior {
		[Serialize("isCustomCurve"                  )] public int isCustomCurve;
		...
		[Serialize("blowOffAction"                  )] public Generic<Ray_AIBlowOffAction_Template> blowOffAction;
		[Serialize("followCurveAction"              )] public Generic<Ray_AIFollowBezierCurveAction_Template> followCurveAction;
		[Serialize("flyIdleAction"                  )] public Generic<Ray_AIFlyIdleAction_Template> flyIdleAction;
