...
namespace UbiArt.ITF {
	...
	public partial class RO2_GameManagerConfig_Template : GameManagerConfig_Template {
		...
		public CList<RO2_CostumeDescriptor_Template> additionalCostumesDescription;
		...
		public CList<Path> HideNSeekIntroCutScenePath;
		public PathRef introMoviePath;
		public CList<RO2_GameManagerConfig_Template.LocalisedVideo> introMoviePathContainer;
		...
		public CList<RO2_CostumeInfo_Template> costumes;
		...
		public CList<RO2_GameManagerConfig_Template.MapConfig> levelsInfo;
		public CList<RO2_GameManagerConfig_Template.WorldConfig> worldsInfo;
		public CList<RO2_GameManagerConfig_Template.InvasionConfig> invasionsInfo;
		public CList<RO2_GameManagerConfig_Template.LockDataClass> lockData;
		public CList<RO2_GameManagerConfig_Template.TagTextClass> tagText;
		public CList<RO2_GameManagerConfig_Template.LuckyTicketUnlock> luckyTicketUnlockList;
		public CList<RO2_GameManagerConfig_Template.RewardPerWorldCompletion> rewardsPerWorldCompletion;
		...
		public CList<RO2_GameManagerConfig_Template.Pet> pets;
		...
		public CList<Path> packageDirectories;
		public CList<Path> environmentBrickPaths;
		public CList<Path> costumeEnvironmentBrickPaths;
		public CList<RO2_GameManagerConfig_Template.LocalisedVideo> ps3HddIntroMoviePathContainer;
		public CList<Path> demoTrailerMoviePathContainer;
		public Path scoreRecapChallengePath;
		public CList<Path> catchTheAllMaps;
		public CList<Path> debugmapslist;
		public CList<Path> packages;
		protected override void SerializeImpl(CSerializerObject s) {
			...
			if (Settings.s.game == Settings.Game.RL) {
				...
				packageDirectories = s.SerializeObject<CList<Path>>(packageDirectories, name: "packageDirectories");
				environmentBrickPath = s.SerializeObject<Path>(environmentBrickPath, name: "environmentBrickPath");
				environmentBrickPaths = s.SerializeObject<CList<Path>>(environmentBrickPaths, name: "environmentBrickPaths");
				...
				costumeEnvironmentBrickPaths = s.SerializeObject<CList<Path>>(costumeEnvironmentBrickPaths, name: "costumeEnvironmentBrickPaths");
				...
				additionalCostumesDescription = s.SerializeObject<CList<RO2_CostumeDescriptor_Template>>(additionalCostumesDescription, name: "additionalCostumesDescription");
				...
				introMoviePathContainer = s.SerializeObject<CList<RO2_GameManagerConfig_Template.LocalisedVideo>>(introMoviePathContainer, name: "introMoviePathContainer");
				ps3HddIntroMoviePathContainer = s.SerializeObject<CList<RO2_GameManagerConfig_Template.LocalisedVideo>>(ps3HddIntroMoviePathContainer, name: "ps3HddIntroMoviePathContainer");
				demoTrailerMoviePathContainer = s.SerializeObject<CList<Path>>(demoTrailerMoviePathContainer, name: "demoTrailerMoviePathContainer");
				...
				costumes = s.SerializeObject<CList<RO2_CostumeInfo_Template>>(costumes, name: "costumes");
				...
				catchTheAllMaps = s.SerializeObject<CList<Path>>(catchTheAllMaps, name: "catchTheAllMaps");
				...
				debugmapslist = s.SerializeObject<CList<Path>>(debugmapslist, name: "debugmapslist");
				...
				packages = s.SerializeObject<CList<Path>>(packages, name: "packages");
				levelsInfo = s.SerializeObject<CList<RO2_GameManagerConfig_Template.MapConfig>>(levelsInfo, name: "levelsInfo");
				worldsInfo = s.SerializeObject<CList<RO2_GameManagerConfig_Template.WorldConfig>>(worldsInfo, name: "worldsInfo");
				invasionsInfo = s.SerializeObject<CList<RO2_GameManagerConfig_Template.InvasionConfig>>(invasionsInfo, name: "invasionsInfo");
				lockData = s.SerializeObject<CList<RO2_GameManagerConfig_Template.LockDataClass>>(lockData, name: "lockData");
				tagText = s.SerializeObject<CList<RO2_GameManagerConfig_Template.TagTextClass>>(tagText, name: "tagText");
				luckyTicketUnlockList = s.SerializeObject<CList<RO2_GameManagerConfig_Template.LuckyTicketUnlock>>(luckyTicketUnlockList, name: "luckyTicketUnlockList");
				rewardsPerWorldCompletion = s.SerializeObject<CList<RO2_GameManagerConfig_Template.RewardPerWorldCompletion>>(rewardsPerWorldCompletion, name: "rewardsPerWorldCompletion");
				...
				pets = s.SerializeObject<CList<RO2_GameManagerConfig_Template.Pet>>(pets, name: "pets");
				...
				HideNSeekIntroCutScenePath = s.SerializeObject<CList<Path>>(HideNSeekIntroCutScenePath, name: "HideNSeekIntroCutScenePath");
				introMoviePath = s.SerializeObject<PathRef>(introMoviePath, name: "introMoviePath");
				introMoviePathContainer = s.SerializeObject<CList<RO2_GameManagerConfig_Template.LocalisedVideo>>(introMoviePathContainer, name: "introMoviePathContainer");
				mainMenuPath = s.SerializeObject<Path>(mainMenuPath, name: "mainMenuPath");
				creditsPath = s.SerializeObject<Path>(creditsPath, name: "creditsPath");
		...
		public partial class MapConfig : CSerializable {
			...
			public CList<StringID> mapDependencies;
			...
			protected override void SerializeImpl(CSerializerObject s) {
				...
				mapDependencies = s.SerializeObject<CList<StringID>>(mapDependencies, name: "mapDependencies");
		...
		public partial class LuckyTicketUnlock : CSerializable {
			public uint mapID;
			public CList<StringID> maps;
			protected override void SerializeImpl(CSerializerObject s) {
				base.SerializeImpl(s);
				mapID = s.Serialize<uint>(mapID, name: "mapID");
				maps = s.SerializeObject<CList<StringID>>(maps, name: "maps");
			}
		}
		[Games(GameFlags.RA)]
		public partial class InvasionConfig : CSerializable {
			...
			public CList<Path> teensies2D;
			public CList<Path> enemies2D;
			public CArray<Generic<Event>> musicModeList;
			protected override void SerializeImpl(CSerializerObject s) {
				base.SerializeImpl(s);
				...
				teensies2D = s.SerializeObject<CList<Path>>(teensies2D, name: "teensies2D");
				enemies2D = s.SerializeObject<CList<Path>>(enemies2D, name: "enemies2D");
				musicModeList = s.SerializeObject<CArray<Generic<Event>>>(musicModeList, name: "musicModeList");
			}
		}
