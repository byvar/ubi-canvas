...
namespace UbiArt.ITF {
	...
	public partial class Ray_AIBubbleDeathBehavior_Template : TemplateAIBehavior {
		...
		[Serialize("rewardAtStart"                    )] public Generic<Ray_EventSpawnReward> rewardAtStart;
		...
		[Serialize("usePhysRadiusAsSoftCollRadius"    )] public int usePhysRadiusAsSoftCollRadius;
		[Serialize("explodeOnPlayer"                  )] public int explodeOnPlayer;
		...
		[Serialize("checkWater"                       )] public int checkWater;
