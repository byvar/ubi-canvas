...
namespace UbiArt.ITF {
	...
	public partial class RO2_PowerUpManager_Template : TemplateObj {
		...
		public CList<float> magnetPhantomScaleMultiplier;
		...
		protected override void SerializeImpl(CSerializerObject s) {
			...
			if (Settings.s.game == Settings.Game.RL) {
				...
				swarmRepellerMaxAmmo = s.Serialize<uint>(swarmRepellerMaxAmmo, name: "swarmRepellerMaxAmmo");
				petFollowerMaxAmmo = s.Serialize<uint>(petFollowerMaxAmmo, name: "petFollowerMaxAmmo");
				magnetPhantomScaleMultiplier = s.SerializeObject<CList<float>>(magnetPhantomScaleMultiplier, name: "magnetPhantomScaleMultiplier");
				...
				magnetCoinMaxAttractedRange = s.SerializeObject<CList<float>>(magnetCoinMaxAttractedRange, name: "magnetCoinMaxAttractedRange");
				magnetCoinInterpolatedSpeed = s.Serialize<float>(magnetCoinInterpolatedSpeed, name: "magnetCoinInterpolatedSpeed");
				magnetFireflyCloudActivationRange = s.SerializeObject<CList<float>>(magnetFireflyCloudActivationRange, name: "magnetFireflyCloudActivationRange");
				magnetLumCageSlowCoef = s.Serialize<float>(magnetLumCageSlowCoef, name: "magnetLumCageSlowCoef");
				magnetRotationSpeed = s.SerializeObject<CList<float>>(magnetRotationSpeed, name: "magnetRotationSpeed");
				...
				radarAnimStepRange = s.SerializeObject<CList<float>>(radarAnimStepRange, name: "radarAnimStepRange");
