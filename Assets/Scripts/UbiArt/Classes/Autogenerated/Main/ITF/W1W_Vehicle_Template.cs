...
namespace UbiArt.ITF {
	...
	public partial class W1W_Vehicle_Template : W1W_InteractiveGenComponent_Template {
		...
		[Serialize("StringID__35")] public StringID StringID__35;
		[Serialize("float__36"   )] public float float__36;
		[Serialize("float__37"   )] public float float__37;
		[Serialize("bool__38"    )] public bool bool__38;
		protected override void SerializeImpl(CSerializerObject s) {
			...
			SerializeField(s, nameof(StringID__35));
			SerializeField(s, nameof(float__36));
			SerializeField(s, nameof(float__37));
			SerializeField(s, nameof(bool__38));
		}
