...
namespace UbiArt.ITF {
	...
	public partial class RO2_LumsChainComponent_Template : ActorComponent_Template {
		...
		public CArray<Vec3d> interactiveActorOffsets;
		public CArray<Path> interactiveActorBgList;
		public CList<float> bgZOffsets;
		...
		protected override void SerializeImpl(CSerializerObject s) {
			...
			if (Settings.s.game == Settings.Game.RL) {
				...
				interactiveActorOffsets = s.SerializeObject<CArray<Vec3d>>(interactiveActorOffsets, name: "interactiveActorOffsets");
				interactiveActorBgList = s.SerializeObject<CArray<Path>>(interactiveActorBgList, name: "interactiveActorBgList");
				bgZOffsets = s.SerializeObject<CList<float>>(bgZOffsets, name: "bgZOffsets");
