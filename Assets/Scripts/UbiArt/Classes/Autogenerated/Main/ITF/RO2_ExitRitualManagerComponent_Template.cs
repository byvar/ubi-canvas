...
namespace UbiArt.ITF {
	...
	public partial class RO2_ExitRitualManagerComponent_Template : ActorComponent_Template {
		...
		public CList<StringID> runeBonesList;
		public CArray<Path> medalPaths;
		public CList<StringID> medalBones;
		...
		protected override void SerializeImpl(CSerializerObject s) {
			...
			if (Settings.s.game == Settings.Game.RL) {
				...
				runeBonesList = s.SerializeObject<CList<StringID>>(runeBonesList, name: "runeBonesList");
				medalPaths = s.SerializeObject<CArray<Path>>(medalPaths, name: "medalPaths");
				medalBones = s.SerializeObject<CList<StringID>>(medalBones, name: "medalBones");
