...
namespace UbiArt.ITF {
	...
	public partial class FriseConfig : Actor_Template {
		...
		[Serialize("CollisionFrieze__20"           )] public CollisionFrieze CollisionFrieze__20;
		[Serialize("FillConfig__21"                )] public FillConfig FillConfig__21;
		...
		[Serialize("Vector2__33"                   )] public Vector2 Vector2__33;
		[Serialize("ColorInteger__34"              )] public ColorInteger ColorInteger__34;
		[Serialize("CArray<FriseTextureConfig>__35")] public CArray<FriseTextureConfig> CArray_FriseTextureConfig__35;
		[Serialize("VertexAnim__36"                )] public VertexAnim VertexAnim__36;
		[Serialize("FluidConfig__37"               )] public FluidConfig FluidConfig__37;
		[Serialize("Mesh3dConfig__38"              )] public Mesh3dConfig Mesh3dConfig__38;
		[Serialize("bool__39"                      )] public bool bool__39;
		[Serialize("float__40"                     )] public float float__40;
		[Serialize("bool__41"                      )] public bool bool__41;
		[Serialize("bool__42"                      )] public bool bool__42;
		[Serialize("bool__43"                      )] public bool bool__43;
		[Serialize("float__44"                     )] public float float__44;
		[Serialize("StringID__45"                  )] public StringID StringID__45;
		[Serialize("StringID__46"                  )] public StringID StringID__46;
		...
		[Serialize("StringID__51"                  )] public StringID StringID__51;
		[Serialize("StringID__52"                  )] public StringID StringID__52;
		[Serialize("StringID__53"                  )] public StringID StringID__53;
		[Serialize("StringID__54"                  )] public StringID StringID__54;
		[Serialize("StringID__55"                  )] public StringID StringID__55;
		[Serialize("StringID__56"                  )] public StringID StringID__56;
		[Serialize("StringID__57"                  )] public StringID StringID__57;
		[Serialize("StringID__58"                  )] public StringID StringID__58;
		[Serialize("StringID__59"                  )] public StringID StringID__59;
		[Serialize("StringID__60"                  )] public StringID StringID__60;
		[Serialize("int__61"                       )] public int int__61;
		[Serialize("bool__62"                      )] public bool bool__62;
		[Serialize("CArray<int>__63"               )] public CArray<int> CArray_int__63;
		[Serialize("CArray<int>__64"               )] public CArray<int> CArray_int__64;
		[Serialize("bool__65"                      )] public bool bool__65;
		[Serialize("GFXPrimitiveParam__66"         )] public GFXPrimitiveParam GFXPrimitiveParam__66;
		[Serialize("Frieze3DConfig__67"            )] public Frieze3DConfig Frieze3DConfig__67;
		protected override void SerializeImpl(CSerializerObject s) {
			...
			if (Settings.s.game == Settings.Game.RO) {
				...
				SerializeField(s, nameof(CollisionFrieze__20));
				SerializeField(s, nameof(FillConfig__21));
				...
				SerializeField(s, nameof(Vector2__33));
				SerializeField(s, nameof(ColorInteger__34));
				SerializeField(s, nameof(CArray_FriseTextureConfig__35));
				SerializeField(s, nameof(VertexAnim__36));
				SerializeField(s, nameof(FluidConfig__37));
				SerializeField(s, nameof(Mesh3dConfig__38));
				SerializeField(s, nameof(bool__39));
				SerializeField(s, nameof(float__40));
				SerializeField(s, nameof(bool__41));
				SerializeField(s, nameof(bool__42));
				SerializeField(s, nameof(bool__43));
				SerializeField(s, nameof(float__44));
				if (s.HasFlags(SerializeFlags.Flags9)) {
					SerializeField(s, nameof(StringID__45));
					SerializeField(s, nameof(StringID__46));
					...
					SerializeField(s, nameof(StringID__51));
					SerializeField(s, nameof(StringID__52));
					SerializeField(s, nameof(StringID__53));
					SerializeField(s, nameof(StringID__54));
					SerializeField(s, nameof(StringID__55));
					SerializeField(s, nameof(StringID__56));
					SerializeField(s, nameof(StringID__57));
					SerializeField(s, nameof(StringID__58));
					SerializeField(s, nameof(StringID__59));
					SerializeField(s, nameof(StringID__60));
				}
				if (s.HasFlags(SerializeFlags.Flags10)) {
					SerializeField(s, nameof(int__61));
					SerializeField(s, nameof(bool__62));
					SerializeField(s, nameof(CArray_int__63));
					SerializeField(s, nameof(CArray_int__64));
					SerializeField(s, nameof(bool__65));
				}
				SerializeField(s, nameof(GFXPrimitiveParam__66));
				SerializeField(s, nameof(Frieze3DConfig__67));
			} else {
				SerializeField(s, nameof(gameMaterial));
				SerializeField(s, nameof(gameMaterialExtremityStart));
				SerializeField(s, nameof(gameMaterialExtremityStop));
