...
namespace UbiArt.ITF {
	...
	public partial class Ray_StringWaveGeneratorComponent_Template : CSerializable {
		...
		[Serialize("isSpike"                        )] public int isSpike;
		...
		[Serialize("isFullLength"                   )] public int isFullLength;
		...
		[Serialize("isSpawner"                      )] public int isSpawner;
		[Serialize("spawneeLimit"                   )] public uint spawneeLimit;
		[Serialize("onOffAffectsAllWaves"           )] public int onOffAffectsAllWaves;
		[Serialize("smallScaleWhenBlackInTransition")] public float smallScaleWhenBlackInTransition;
		[Serialize("limitWaveToBorders"             )] public int limitWaveToBorders;
