...
namespace UbiArt.ITF {
	...
	public partial class W1W_FlareGenerator : ActorComponent {
		...
		protected override void SerializeImpl(CSerializerObject s) {
			...
			CArray_Generic_Event__4 = s.SerializeObject<CArrayO<Generic<Event>>>(CArray_Generic_Event__4, name: "CArray_Generic_Event__4");
			CArray_Generic_Event__5 = s.SerializeObject<CArrayO<Generic<Event>>>(CArray_Generic_Event__5, name: "CArray_Generic_Event__5");
			CArray_Generic_Event__6 = s.SerializeObject<CArrayO<Generic<Event>>>(CArray_Generic_Event__6, name: "CArray_Generic_Event__6");
		}
