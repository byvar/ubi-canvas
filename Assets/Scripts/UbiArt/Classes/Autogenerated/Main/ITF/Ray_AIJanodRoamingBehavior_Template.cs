...
namespace UbiArt.ITF {
	...
	public partial class Ray_AIJanodRoamingBehavior_Template : Ray_AIJanodRoamingBaseBehavior_Template {
		...
		[Serialize("mustTrackVictim"               )] public int mustTrackVictim;
		...
		[Serialize("isAsleep"                      )] public int isAsleep;
		[Serialize("hasConstantX"                  )] public int hasConstantX;
		[Serialize("hasContantCoordinate_Force"    )] public float hasContantCoordinate_Force;
		[Serialize("isCycleBased"                  )] public int isCycleBased;
