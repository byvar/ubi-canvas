...
namespace UbiArt.ITF {
	...
	public partial class W1W_SafeLock : W1W_Wheel {
		...
		protected override void SerializeImpl(CSerializerObject s) {
			...
			CArray_ushort__0 = s.SerializeObject<CArrayP<ushort>>(CArray_ushort__0, name: "CArray_ushort__0");
			bool__1_ = s.Serialize<bool>(bool__1_, name: "bool__1_");
			CArray_EventSender__2 = s.SerializeObject<CArrayO<EventSender>>(CArray_EventSender__2, name: "CArray_EventSender__2");
