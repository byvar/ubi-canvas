...
namespace UbiArt.ITF {
	...
	public partial class RLC_TutoTriggerComponent : ActorComponent {
		...
		public CList<RLC_TutoTriggerComponent.ActionToUnpause> ActionsToResume;
		...
		public CArray<Generic<Event>> onResumeEvent;
		...
		protected override void SerializeImpl(CSerializerObject s) {
			...
			ActionsToResume = s.SerializeObject<CList<RLC_TutoTriggerComponent.ActionToUnpause>>(ActionsToResume, name: "ActionsToResume");
			...
			onResumeEvent = s.SerializeObject<CArray<Generic<Event>>>(onResumeEvent, name: "onResumeEvent");
