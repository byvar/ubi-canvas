...
namespace UbiArt.ITF {
	...
	public partial class W1W_GameManagerConfig_Template : GameManagerConfig_Template {
		...
		protected override void SerializeImpl(CSerializerObject s) {
			...
			CArray_W1W_GameManagerConfig_Template_LocalisedVideo__13 = s.SerializeObject<CArrayO<W1W_GameManagerConfig_Template.LocalisedVideo>>(CArray_W1W_GameManagerConfig_Template_LocalisedVideo__13, name: "CArray_W1W_GameManagerConfig_Template_LocalisedVideo__13");
			Path__14 = s.SerializeObject<Path>(Path__14, name: "Path__14");
			CArray_W1W_GameManagerConfig_Template_LocalisedVideo__15 = s.SerializeObject<CArrayO<W1W_GameManagerConfig_Template.LocalisedVideo>>(CArray_W1W_GameManagerConfig_Template_LocalisedVideo__15, name: "CArray_W1W_GameManagerConfig_Template_LocalisedVideo__15");
			PathRef__16 = s.SerializeObject<PathRef>(PathRef__16, name: "PathRef__16");
			CArray_W1W_GameManagerConfig_Template_LocalisedVideo__17 = s.SerializeObject<CArrayO<W1W_GameManagerConfig_Template.LocalisedVideo>>(CArray_W1W_GameManagerConfig_Template_LocalisedVideo__17, name: "CArray_W1W_GameManagerConfig_Template_LocalisedVideo__17");
			Path__18 = s.SerializeObject<Path>(Path__18, name: "Path__18");
			CArray_W1W_GameManagerConfig_Template_LocalisedVideo__19 = s.SerializeObject<CArrayO<W1W_GameManagerConfig_Template.LocalisedVideo>>(CArray_W1W_GameManagerConfig_Template_LocalisedVideo__19, name: "CArray_W1W_GameManagerConfig_Template_LocalisedVideo__19");
			Path__20 = s.SerializeObject<Path>(Path__20, name: "Path__20");
			CArray_W1W_GameManagerConfig_Template_LocalisedVideo__21 = s.SerializeObject<CArrayO<W1W_GameManagerConfig_Template.LocalisedVideo>>(CArray_W1W_GameManagerConfig_Template_LocalisedVideo__21, name: "CArray_W1W_GameManagerConfig_Template_LocalisedVideo__21");
			Path__22 = s.SerializeObject<Path>(Path__22, name: "Path__22");
			CArray_W1W_GameManagerConfig_Template_LocalisedVideo__23 = s.SerializeObject<CArrayO<W1W_GameManagerConfig_Template.LocalisedVideo>>(CArray_W1W_GameManagerConfig_Template_LocalisedVideo__23, name: "CArray_W1W_GameManagerConfig_Template_LocalisedVideo__23");
			Path__24 = s.SerializeObject<Path>(Path__24, name: "Path__24");
			CArray_W1W_GameManagerConfig_Template_LocalisedVideo__25 = s.SerializeObject<CArrayO<W1W_GameManagerConfig_Template.LocalisedVideo>>(CArray_W1W_GameManagerConfig_Template_LocalisedVideo__25, name: "CArray_W1W_GameManagerConfig_Template_LocalisedVideo__25");
			PathRef__26 = s.SerializeObject<PathRef>(PathRef__26, name: "PathRef__26");
			CArray_W1W_GameManagerConfig_Template_MapConfig__27 = s.SerializeObject<CArrayO<W1W_GameManagerConfig_Template.MapConfig>>(CArray_W1W_GameManagerConfig_Template_MapConfig__27, name: "CArray_W1W_GameManagerConfig_Template_MapConfig__27");
			CArray_W1W_GameManagerConfig_Template_EpisodeConfig__28 = s.SerializeObject<CArrayO<W1W_GameManagerConfig_Template.EpisodeConfig>>(CArray_W1W_GameManagerConfig_Template_EpisodeConfig__28, name: "CArray_W1W_GameManagerConfig_Template_EpisodeConfig__28");
			CArray_W1W_GameManagerConfig_Template_WikiMapConfig__29 = s.SerializeObject<CArrayO<W1W_GameManagerConfig_Template.WikiMapConfig>>(CArray_W1W_GameManagerConfig_Template_WikiMapConfig__29, name: "CArray_W1W_GameManagerConfig_Template_WikiMapConfig__29");
			CArray_W1W_GameManagerConfig_Template_LocalNotificationConfig__30 = s.SerializeObject<CArrayO<W1W_GameManagerConfig_Template.LocalNotificationConfig>>(CArray_W1W_GameManagerConfig_Template_LocalNotificationConfig__30, name: "CArray_W1W_GameManagerConfig_Template_LocalNotificationConfig__30");
			CArray_PathRef__31 = s.SerializeObject<CArrayO<PathRef>>(CArray_PathRef__31, name: "CArray_PathRef__31");
			CArray_W1W_GameManagerConfig_Template_CharDiaMapConfig__32 = s.SerializeObject<CArrayO<W1W_GameManagerConfig_Template.CharDiaMapConfig>>(CArray_W1W_GameManagerConfig_Template_CharDiaMapConfig__32, name: "CArray_W1W_GameManagerConfig_Template_CharDiaMapConfig__32");
			CArray_W1W_GameManagerConfig_Template_ChardiaJumpCharConfig__33 = s.SerializeObject<CArrayO<W1W_GameManagerConfig_Template.ChardiaJumpCharConfig>>(CArray_W1W_GameManagerConfig_Template_ChardiaJumpCharConfig__33, name: "CArray_W1W_GameManagerConfig_Template_ChardiaJumpCharConfig__33");
			CArray_uint__34 = s.SerializeObject<CArrayP<uint>>(CArray_uint__34, name: "CArray_uint__34");
			...
			CArray_W1W_GameManagerConfig_Template_ClueTimedType__60 = s.SerializeObject<CArrayO<W1W_GameManagerConfig_Template.ClueTimedType>>(CArray_W1W_GameManagerConfig_Template_ClueTimedType__60, name: "CArray_W1W_GameManagerConfig_Template_ClueTimedType__60");
			...
			CArray_uint__102 = s.SerializeObject<CArrayP<uint>>(CArray_uint__102, name: "CArray_uint__102");
			CArray_uint__103 = s.SerializeObject<CArrayP<uint>>(CArray_uint__103, name: "CArray_uint__103");
