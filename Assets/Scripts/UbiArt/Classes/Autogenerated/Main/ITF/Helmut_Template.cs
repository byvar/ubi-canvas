...
namespace UbiArt.ITF {
	...
	public partial class Helmut_Template : Npc_Template {
		...
		protected override void SerializeImpl(CSerializerObject s) {
			...
			float__1_ = s.Serialize<float>(float__1_, name: "float__1_");
			float__2_ = s.Serialize<float>(float__2_, name: "float__2_");
			float__3_ = s.Serialize<float>(float__3_, name: "float__3_");
			float__4_ = s.Serialize<float>(float__4_, name: "float__4_");
			float__5_ = s.Serialize<float>(float__5_, name: "float__5_");
			float__6_ = s.Serialize<float>(float__6_, name: "float__6_");
