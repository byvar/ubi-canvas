...
namespace UbiArt.ITF {
	...
	public partial class Ray_AIGround_ReceiveNormalHitAction_Template : Ray_AIGroundReceiveHitAction_Template {
		...
		[Serialize("mustFinishWithHurtTimer"    )] public int mustFinishWithHurtTimer;
		[Serialize("resetSpeedAtStart"          )] public int resetSpeedAtStart;
		[Serialize("orientVerticalForceToGround")] public int orientVerticalForceToGround;
