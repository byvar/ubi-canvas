...
namespace UbiArt.ITF {
	...
	public partial class Ray_PlatformAIComponent_Template : CSerializable {
		...
		[Serialize("synchronizeActivationTransitions"   )] public int synchronizeActivationTransitions;
		...
		[Serialize("synchronizeOpenCloseTransitions"    )] public int synchronizeOpenCloseTransitions;
		[Serialize("closeTimeHysteresis"                )] public float closeTimeHysteresis;
		[Serialize("closeOnHit"                         )] public int closeOnHit;
		...
		[Serialize("synchronizeOpenCloseFullTransitions")] public int synchronizeOpenCloseFullTransitions;
		...
		[Serialize("manageVacuum"                       )] public int manageVacuum;
