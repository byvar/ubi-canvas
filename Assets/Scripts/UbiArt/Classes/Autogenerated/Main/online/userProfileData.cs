...
namespace UbiArt.online {
	public partial class userProfileData : userProfileOtherData {
		...
		[Serialize("KEY"                 )] public string KEY;
		[Serialize("VAL"                 )] public uint VAL;
		[Serialize("hatchingParams"      )] public CArray<uint> hatchingParams;
		[Serialize("seasonalEventList"   )] public CMap<uint, ITF.RO2_PersistentGameData_Universe.SeasonalEventData> seasonalEventList;
		[Serialize("clusteringInfo"      )] public CArray<float> clusteringInfo;
		[Serialize("playerPopulations"   )] public CMap<ITF.StringID, ITF.StringID> playerPopulations;
